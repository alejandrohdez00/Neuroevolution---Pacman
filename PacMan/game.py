...
class Game(object):
    def __init__(self):
        ...
        # Create the player
        self.player = Player(32,128,"Pacman\media\player.png")
        ...
        self.pacman_sound = pygame.mixer.Sound("Pacman\media\pacman_sound.ogg")
        self.game_over_sound = pygame.mixer.Sound("Pacman\media\game_over_sound.ogg")
